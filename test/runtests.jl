...
# Version of: UTC 2019-10-17 18:20:31
# 09f54532-f0fa-11e9-19d3-ed11635532ec
...
@testset "Multinacci" begin
    ...
    @test [Multinacci(6, n) for n in 0:9] == [
        1,
        1,
        6,
        7,
    ...
    @test [Multinacci(7, n) for n in 0:9] == [
        1,
        1,
        7,
        8,
    ...
    @test [Multinacci(8, n) for n in 0:9] == [
        1,
        1,
        8,
        9,
