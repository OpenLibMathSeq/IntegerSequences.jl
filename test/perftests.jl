...
# Version of: UTC 2019-10-06 23:49:23
# 28d4b820-e883-11e9-16e4-d3bf9293ae3a
...
# +++ IntPartitions.jl +++
println("\n-- performance test")
println("\nTEST: for n in 1:50, p in IntegerPartitions(n, byNumPart::PartitionOrder) p end")
@time for n in 1:50, p in IntegerPartitions(n, byNumPart::PartitionOrder) p end
println("\nTEST: for n in 1:50, p in IntegerPartitions(n, byMaxPart::PartitionOrder) p end")
